...
function Navbar({ user, admin, loaded }) {
			...
			return (
				<>
					...
					>
						...
						<span className="m-2">{user.name.firstName || "User"}</span>
					</NavLink>
					{admin ? (
						<NavLink
							className="navlink"
	...
	const displayMobile = () => {
		...
		return (
			<div className="menu-icon">
				...
				>
					<div className="menu-choices" onClick={() => handleDrawerClose()}>
						{getDrawerChoices()}
					</div>
					{isAuth ? (
		...
		<>
			<nav className=" navbar1">
				...
				<a className="site-name" href="/">
					...
					<img src={siteName} className="siteName" alt="IIITM-Kart" />
				</a>
